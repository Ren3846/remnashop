...
msg-menu-connect-guide =
    📖 <b>Как подключиться к VPN</b>

    1. Скачайте приложение <b>Happ</b> с помощью кнопок ниже.

    2. Нажмите <b>«📋 Получить ссылку подписки»</b> — бот пришлёт ссылку отдельным сообщением. Скопируйте её.

    3. Откройте приложение и нажмите кнопку <b>+</b> в правом верхнем углу, в открывшемся меню выберите <b>«Вставить из буфера обмена»</b>.

    3.1. Если приложение открыто впервые, можно нажать кнопку <b>«Из буфера»</b> в левом нижнем углу.

    4. После добавления подписки выберите сервер и нажмите большую кнопку в центре экрана.
...
msg-subscription-email =
    ...
    Он будет привязан к VPN-подписке в Remnawave.

msg-subscription-email-confirm =
    <b>Введите код подтверждения из письма.</b>

    Мы отправили 6-значный код на указанный email.
